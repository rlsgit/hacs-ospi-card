...
let OSPiCardRuntimeDialog = class OSPiCardRuntimeDialog extends s {
    constructor() {
        super(...arguments);
        this.open = false;
    }
...
__decorate([
    r()
], OSPiCardRuntimeDialog.prototype, "open", void 0);
__decorate([
    r()
], OSPiCardRuntimeDialog.prototype, "runtime", void 0);
__decorate([
    r()
], OSPiCardRuntimeDialog.prototype, "error", void 0);
OSPiCardRuntimeDialog = __decorate([
    t('ospi-card-runtime-dialog')
], OSPiCardRuntimeDialog);
var OSPiCardRuntimeDialog$1 = OSPiCardRuntimeDialog;
...
let OSPiStationCard = class OSPiStationCard extends s {
    ...
    render() {
        ...
        let ret = x ``;
        if (this.config) {
            ret = x ` <ha-card> ${this.cardImage()} ${this.cardName()} ${this.cardStatus()} ${this.progress()} ${this.history()} </ha-card> `;
        }
        return ret;
    }
    connectedCallback() {
        super.connectedCallback();
        this.runtimeDialog = new OSPiCardRuntimeDialog$1();
...
let OSPiCardEditor = class OSPiCardEditor extends s {
    constructor() {
        super(...arguments);
...
__decorate([
    n({ attribute: false })
], OSPiCardEditor.prototype, "hass", void 0);
__decorate([
    r()
], OSPiCardEditor.prototype, "config", void 0);
__decorate([
    r()
], OSPiCardEditor.prototype, "helpers", void 0);
__decorate([
    r()
], OSPiCardEditor.prototype, "options", void 0);
OSPiCardEditor = __decorate([
    t(OSPiStationCardConfigElement.type)
], OSPiCardEditor);

export { OSPiCardEditor, OSPiStationCardConfigElement, OSPiStationCardElement, defaultIcons, defaultRuntime, defaults, fireEvent, getEntities, getEntityState, hasManual, hasRainDelayActive, hasRunOnce, isController, isEnabled, isPlayPausable, isProgram, isRainDelayActiveSensor, isRainDelayStopTime, isRunOnce, isState, isStation, isStationProgEnable, osName, stateActivated, stateStoppable, stateWaiting };
